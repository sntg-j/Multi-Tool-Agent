...
class Wrapper:
    """
        ...
        - The input of the wrapper function is a message in the form of a string.
        - As such, the result needs to be a string for the ChatBot object to read the information properly.
    """
