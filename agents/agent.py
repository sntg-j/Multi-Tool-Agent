...
class Agent:
    """This class is not meant to override any other Langchain method, but to consolidate the components 
        of that allow functionality in the Agent Workflow to mimic builtin LangChain Agent/AgentExecutor classes.
    ...
    # abbreviates call, applying the same method in the base class
