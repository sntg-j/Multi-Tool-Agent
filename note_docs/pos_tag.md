General POS TAG LIST:
CC      coordinating conjunction
CD      cardinal digit
DT      determiner
EX      existential there (like: "there is" or "there exists")
FW      foreign word
IN      preposition/subordinating conjunction
JJ      adjective
JJR     adjective, comparative 'bigger'
JJS     adjective, superiative 'biggest'
LS      list marker '1)'
MD      modal, could will
NN      noun, singular
NNS     noun, plural
...
RB      adverb, comparative 'better'
RBR     adverb, superiative 'best'
RP      particle give up
...
VBN     verb, past participle took
VBP     verb, singular present, non-3rd take
...
Yes — exactly. You couldn’t find it in standard `nltk.help.upenn_tagset()` because the Brown Corpus does **not** use the Penn Treebank tagset.

It uses the original Brown tagset, which NLTK exposes — but doesn’t document as prominently.

Below I’ll give you:

1. 📘 The official source
2. 📍 Where it exists inside NLTK
3. 🗂 A clean markdown version of the Brown tagset
4. 🔎 The direct academic reference

---

# 📘 Official Source of the Brown Tagset

The tagset comes from:

> Francis, W. Nelson & Kučera, Henry (1964).
...
This manual documents the original tagging scheme for the Brown Corpus.

Later revisions are documented in:

> Kučera & Francis (1967), *Computational Analysis of Present-Day American English*

---

# 📍 Where to Find It in NLTK

NLTK includes Brown’s tagset documentation.
...
This prints the official descriptions bundled with NLTK.
...
# 📂 Direct Online Source (Brown Tagset Reference)

The canonical documentation is archived here:

Brown Corpus Manual (University of Michigan archive):
[http://clu.uni.no/icame/brown/bcm.html](http://clu.uni.no/icame/brown/bcm.html)

Mirror:
[http://icame.uib.no/brown/bcm.html](http://icame.uib.no/brown/bcm.html)

These contain the official tag explanations.

---

# 🗂 Brown Tagset (Clean Markdown Version)

Below is a structured version of the core tags.
...
| Tag  | Meaning                     |
| ---- | --------------------------- |
| ppss | nominative personal pronoun |
| ppo  | objective pronoun           |
...
# 🔎 Brown-Specific Suffix Markers

These modify the base tag:
...
| -hl    | word in headline    |
| -nc    | cited form          |
| fw-    | foreign word prefix |
| +      | contraction marker  |

Example:

```
ppss+hvd  → pronoun + had
nn-tl     → noun in title
```

---

# 🧠 Why It’s Not Prominent in NLTK Docs

Because modern NLP has mostly standardized on:

* Penn Treebank
* Universal POS

The Brown tagset is historically important but less used in modern pipelines.

---

# 📚 Academic Reference (Citable)

If you need a citation:

Francis, W. N., & Kučera, H. (1964).
*Manual of Information to Accompany A Standard Corpus of Present-Day Edited American English.*
...
* ✅ A CSV version
* ✅ A LaTeX table
* ✅ A full expanded tagset including rare tags
* ✅ A mapping from Brown → Penn → Universal POS
